...
const ScoreGraph = () => {
  ...
  if (loading) {
    return <div className="ranking-container"><p style={{ textAlign: 'center' }}>グラフを読み込み中...</p></div>;
  }
  ...
  return (
    <div className="ranking-container">
      ...
      <p style={{ fontSize: '0.8em', color: '#666', textAlign: 'center', marginTop: '10px' }}>
        ※各対局終了時点での累積合計スコアを表示しています。
      </p>
    </div>
  );
};
